...
contract StrategyRegistry {
    ...
    function setStrategyAddress(string memory strategyName, address strategyAddress) public onlyOwner {
    ...
    function removeStrategyAddress(string memory strategyName) public onlyOwner {
        require(strategyAddresses[strategyName] != address(0), "Strategy not found");
        delete strategyAddresses[strategyName];
    }

    function getStrategyAddress(string memory strategyName) public view returns (address) {
